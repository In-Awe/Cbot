    ...
    return (
        <Card>
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-100">Bot Strategy Notes</h2>
                 <button
                    onClick={handleCopy}
            ...
            <p className="text-sm text-gray-400 mb-4">
                This is the live JavaScript code powering the bot, based on the 'Leviathan Apex' strategy. You can copy it to analyze, modify, or test it externally.
            </p>
